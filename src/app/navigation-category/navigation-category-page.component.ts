...
export const NAVIGATION_CATEGORIES: NavigationCategory[] = [
  {
    ...
    description: 'Start with the foundations, then sharpen the decisions that matter for your role and your next fight.',
    items: [
  ...
  },
  {
    ...
    description: 'Quick references for concepts, current numbers, and lessons you can watch when you need an example.',
    items: [
  ...
  },
  {
    ...
    description: 'Use these tools before you queue, after a tough fight, or when you want a more deliberate practice session.',
    items: [
